...
public class Compiler
{
    ...
    private JasminBytecode compile(CharStream input, String className)
    {
        ...
        JasminBytecode jasminCode = generateCode(parseTree, className);

        // Phase 5: Generate methods
		return generateMethods(parseTree, jasminCode);
    }
    ...
    {
        ParlementLexer lexer = new ParlementLexer(input);
    ...
    {
        ParlementParser parser = new ParlementParser(tokens);
    ...
    private JasminBytecode generateCode(ParseTree parseTree, String className)
    {
        ...
        // Generate code
        codeGenerator = new CodeGenerator(jasminBytecode, className);
	...
	/**
	 * Generates the methods below the main method
	 */
    public JasminBytecode generateMethods(ParseTree parseTree, JasminBytecode jasminBytecode)
	{

		MethodGenerator methodGenerator = new MethodGenerator(jasminBytecode, codeGenerator);
		methodGenerator.visit(parseTree);
